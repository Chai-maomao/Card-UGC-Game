...
@warning_ignore("unused_signal")
signal rpc_resume_state_requested(requesting_player: int, known_revision: int, nonce: String)
@warning_ignore("unused_signal")
signal rpc_resume_state_received(state: Dictionary, source_player: int, target_player: int, nonce: String)
@warning_ignore("unused_signal")
signal rpc_resume_state_ack_received(player: int, revision: int, nonce: String)
@warning_ignore("unused_signal")
signal rpc_resume_complete_received(revision: int, nonce: String)
@warning_ignore("unused_signal")
